...
Later EVT disposition: use that official standard 2x20 geometry as the
representative basis; exact factory MPN is not an EVT blocker. The selected
prototype target is a controlled 9.5 mm PCB-surface gap with M2 hardware; see
`STACK_EVT_PLAN.md`. Production qualification remains separate.
